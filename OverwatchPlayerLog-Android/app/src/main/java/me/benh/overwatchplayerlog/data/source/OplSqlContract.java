...
public final class OplSqlContract {
    ...
    //"create table MetaInfo(Key text unique, Value text)"
    //"create table Players (id text unique, BattleTag text unique, Platform text, Region text, IsFavorite boolean, Rating smallint, Note text, CreationDateTime datetime, LastUpdateDateTime datetime)"
